...
public class test {
	public static void main(String[] args) throws MalformedURLException, RemoteException, NotBoundException{			
		...
		//CalClient.afficherOneEventOrder(server, 5);
		//CalClient.afficherEventsUserOrder(server, 5);
		//CalClient.createEventOrder(server, 5, "test", "3-MAY-17 9:00:00", "3-MAY-17 10:00:00");
		//CalClient.updateEventOrder(server, 1, "update event 1", "3-MAY-17 9:00:00", "3-MAY-17 10:00:00");
