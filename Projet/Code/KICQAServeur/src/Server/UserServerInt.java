...
public interface UserServerInt extends Remote {
	 ...
	 * 
	 * @param s
	 *            la chaine de caractere a afficher
	 * @param id
	 ...
	 *            le client
	 * @param idUser2
	 *            l'utilisateur avec qui on veut ajouter une relation
	 * @throws RemoteException
	 *             s'il y a un problem de communication
	 */
	 ...
	 *            le client
	 * @param idUser2
	 *            l'utilisateur avec qui on veut supprimer une relation
	 * @throws RemoteException
	 *             s'il y a un problem de communication
	 */
	 ...
	 * @param userName
	 *            le nouveau login
	 * @throws RemoteExceptions'il
	 *             y a un problem de communication
	 */
	...
	/**
	 * sert a ajouter le client a dans la base de donnees avec le login userName
